...
distraction <- read.csv("/Users/neslihanonay/Desktop/Ulrike_internship/Test/203_DistractionTask.csv", header = TRUE) #read the encoding file
View(distraction) #just to check encoding file
test <- readMat("/Users/neslihanonay/Desktop/Ulrike_internship/Test/203_dataOut.mat") #to read matlab-test file
...
#Sum of "Remember" Responses for
#31)source memory is answered as correct and for correct "Remember" for all.
#32)source memory is answered as correct and for correct "Remember" for "negative" images for "look" condition.
#33)source memory is answered as correct and for correct "Remember" for "negative" images for "distract" condition.
#34)source memory is answered as correct and for correct "Remember" for "negative" images for "reappraise" condition.
#35)source memory is answered as correct and for correct "Remember" for "neutral" images.
#Sum of "Know" Responses for
#36)source memory is answered as correct and for correct "Know" for all.
#37)source memory is answered as correct and for correct "Know" for "negative" images for "look" condition.
#38)source memory is answered as correct and for correct "Know" for "negative" images for "distract" condition.
#39)source memory is answered as correct and for correct "Know" for "negative" images for "reappraise" condition.
#40)source memory is answered as correct and for correct "Know" for "neutral" images.
#Sum of "Remember or Know" Responses for
#41)source memory is answered as correct and for correct "Remember or Know" for all.
#42)source memory is answered as correct and for correct "Remember or Know" for "negative" images for "look" condition.
#43)source memory is answered as correct and for correct "Remember or Know" for "negative" images for "distract" condition.
#44)source memory is answered as correct and for correct "Remember or Know" for "negative" images for "reappraise" condition.
#45)source memory is answered as correct and for correct "Remember or Know" for "neutral" images.
one_idk_R <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"),14])/48
two_idk_R <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="look"),14])/12
three_idk_R <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="distract"),14])/12
four_idk_R <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="reappraise"),14])/12
five_idk_R <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Neutral"),14])/12
six_idk_K <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"),15])/48
seven_idk_K <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="look"),15])/12
eight_idk_K <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="distract"),15])/12
nine_idk_K <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="reappraise"),15])/12
ten_idk_K <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Neutral"),15])/12
eleven_idk_RK <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"),16])/48
twelve_idk_RK <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="look"),16])/12
thirteen_idk_RK <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="distract"),16])/12
fourteen_idk_RK <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="reappraise"),16])/12
fifteen_idk_RK <- sum(emo_ef_clean[which(emo_ef_clean$source== "4"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Neutral"),16])/12
sixteen_wr_R <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"),14])/48
seventeen_wr_R <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="look"),14])/12
eighteen_wr_R <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="distract"),14])/12
nineteen_wr_R <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="reappraise"),14])/12
twenty_wr_R <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Neutral"),14])/12
twntone_wr_K <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"),15])/48
twntwo_wr_K <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="look"),15])/12
twnthree_wr_K <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="distract"),15])/12
twntfour_wr_K <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="reappraise"),15])/12
twntfive_wr_K <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Neutral"),15])/12
twnsix_wr_RK <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"),16])/48
twntsvn_wr_RK <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="look"),16])/12
twnteight_wr_RK <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="distract"),16])/12
twntnine_wr_RK <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="reappraise"),16])/12
thirty_wr_RK <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "0"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Neutral"),16])/12
thirtyone_wr_R <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"),14])/48
thirtytwo_wr_R <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="look"),14])/12
thirtythree_wr_R <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="distract"),14])/12
thirtyfour_wr_R <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="reappraise"),14])/12
thirtyfive_wr_R <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Neutral"),14])/12
thirtysix_wr_K <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"),15])/48
thirtyseven_wr_K <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="look"),15])/12
thirtyeight_wr_K <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="distract"),15])/12
thirtynine_wr_K <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="reappraise"),15])/12
fourty_wr_K <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Neutral"),15])/12
fourtyone_wr_RK <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"),16])/48
fourtytwo_wr_RK <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="look"),16])/12
fourtythree_wr_RK <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="distract"),16])/12
fourtyfour_wr_RK <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Negative"&emo_ef_clean$emo_reg_type=="reappraise"),16])/12
fourtyfive_wr_RK <- sum(emo_ef_clean[which(emo_ef_clean$source_acc== "1"&emo_ef_clean$new_old =="old"&emo_ef_clean$mgType == "Neutral"),16])/12
...
mean_stars_neu_emo_reg_look, one_idk_R, two_idk_R, three_idk_R, four_idk_R, five_idk_R, six_idk_K,
seven_idk_K, eight_idk_K, nine_idk_K, ten_idk_K, eleven_idk_RK, twelve_idk_RK, thirteen_idk_RK, fourteen_idk_RK,
fifteen_idk_RK, sixteen_wr_R, seventeen_wr_R, eighteen_wr_R, nineteen_wr_R)

View(all_together)
write_xlsx(all_together, "/Users/neslihanonay/Desktop/Ulrike_internship/Data/Model/Disney/204.xlsx") #two things to update: path(put your own path, and subject number)
